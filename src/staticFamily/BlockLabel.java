...
public class BlockLabel implements Serializable{
	...
	///////////////////////////////////////// utility
	@Override
	public BlockLabel clone()
	{
		BlockLabel result = new BlockLabel();
		result.getNormalLabels().addAll(this.normalLabels);
		result.normalLabelSection = this.normalLabelSection;
		result.getTryLabels().addAll(this.tryLabels);
		return result;
	}
